...
```cpp
 	QRegExp reg_exp("[A-Za-z0-9_]+$");
    ui->username_edit->setValidator(new QRegExpValidator(reg_exp, ui->username_edit));
    ui->password_edit->setValidator(new QRegExpValidator(reg_exp, ui->password_edit));
```
